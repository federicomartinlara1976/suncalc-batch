...
- **Versión 1.0.2**
    ...
    - 11/07/2026
      - Hacer endpoint para consultar por una fecha en concreto
      - Hacer endpoint para consultar por un rango de fechas. El resultado será una colección de varios elementos.
